...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <script>
        function highlightSettingsIcon() {
            ...
            if (settingsIconContainer.classList.contains('bg-[#ff66c4]')) {
                settingsIconContainer.classList.remove('bg-[#ff66c4]');
                settingsIconContainer.classList.add('bg-[#181C23]');
            } else {
                settingsIconContainer.classList.remove('bg-[#181C23]');
                settingsIconContainer.classList.add('bg-[#ff66c4]');
            }
        }
    </script>
</html>